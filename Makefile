...
#    Updated: 2019/06/15 21:04:05 by smorty           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS1 = $(addprefix $(SRCDIR),push_swap.c utility.c array.c operators.c stacks.c solve_small.c solve_big.c optimization.c)
